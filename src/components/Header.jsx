  ...
  return (
    <header className="text-gray-600 body-font shadow-lg">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to={'/cart'} className="inline-flex items-center bg-green-500 border-0 py-1 px-4 focus:outline-none text-white hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
          Go to Cart
          <svg
            fill="none"
            stroke="currentColor"
