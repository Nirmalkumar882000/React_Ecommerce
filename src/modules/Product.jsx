          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              <div className="flex justify-between items-center">
                <button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded" onClick={()=> handleCart(product,true)}>
                  Buy it now
                </button>
                <button
                  className="flex ml-auto border  border-green-500  py-2 px-6 focus:outline-none hover:bg-green-600
          hover:text-white rounded mr-2"
